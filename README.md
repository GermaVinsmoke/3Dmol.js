...
Since 3Dmol.js is licensed under the permissive BSD open-source license, you are free to use it any project, as long the code is properly acknowledged and [cited](http://dx.doi.org/10.1093/bioinformatics/btu829).
...
Please check out our documentation at https://3dmol.csb.pitt.edu/doc/index.html we have tutorials as well as the stable release of the platform.
